...
describe("getElectionCandidateProfileForUser", () => {
  it("anexa os eventos imutáveis corretos a cada interação do perfil", async () => {
    ...
    const favorite = { id: 12, candidateId: 31, userId: 7, status: "Abordado", lastContactAt: new Date(), followUpAt: null, note: "Conversa em andamento" };
    const responses = [[candidate], reviews, interactions, events, [favorite]]; let index = 0;
