...
A validação de tipos, 41 testes automatizados — incluindo cópia confirmada, WhatsApp público e ausência de canal declarado — e o build de produção foram executados com êxito após esta atualização.
